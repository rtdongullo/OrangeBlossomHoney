    ...
    <footer className="bg-[#2D1B0F] text-white py-10 px-6 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        ...
        <div className="w-full flex justify-center md:justify-end">
          ...
          <div>
            <h3 className="text-yellow-500 text-xl font-serif tracking-wide font-semibold mb-3 text-center md:text-left">Quick Links</h3>
        ...
        <div className="flex flex-col items-center md:items-end">
          <h3 className="text-yellow-500 text-lg font-serif tracking-wide font-semibold mb-3">Follow Us</h3>
      ...
      <div className="border-t border-gray-700 mt-6 pt-4 text-center text-gray-400 text-sm">
        &copy; {new Date().getFullYear()} Lifestyle Honey.
      </div>
    </footer>
  );
};
